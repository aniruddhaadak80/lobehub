export default {
  ...
  'taskSchedule.clear': '清除配置',
  'taskSchedule.every': '执行间隔',
  'taskSchedule.hours': '小时',
  'taskSchedule.interval': '周期执行',
  'taskSchedule.intervalTab': '周期执行',
  'taskSchedule.minutes': '分钟',
  'taskSchedule.scheduler': '定时任务',
  'taskSchedule.schedulerNotReady': '定时任务功能即将上线',
